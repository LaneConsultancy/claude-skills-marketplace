...
1. Is every spelling British: -ise/-isation, -our, -re, -ce nouns / -se verbs, doubled l before suffixes?
2. Are dates day-month-year, money £-prefixed, and units metric?
3. Are American vocabulary choices replaced with British equivalents?
4. Were quotes, proper nouns, brand names, code, and URLs left untouched by the conversion?
5. If the draft was deliberately kept US English, is that stated in the What changed section?

## Calibration

1. Was the edit depth matched to the content type from the calibration table?
2. For local pages, are town, trade, service names, phone numbers, hours, and coverage areas intact and not deduplicated as synonym cycling?
3. For sales copy, were benefits, proof points, and CTAs kept and only unsupported claims cut?
4. Was nothing edited inside a quote or testimonial?
